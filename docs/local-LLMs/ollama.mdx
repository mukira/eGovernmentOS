...
description: "Configure Ollama to work with eGovernmentOS for local AI capabilities"
icon: "robot"
---
...
<Steps>
  <Step title="Navigate to AI Settings">
    Navigate to `chrome://egovernmentos/settings` or click the **Settings** icon on the new tab page to add Ollama as a provider.
  </Step>
