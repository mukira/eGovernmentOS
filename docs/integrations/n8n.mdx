...
description: "Connect eGovernmentOS MCP to n8n for AI-powered browser automation workflows"
icon: "workflow"
---

Build AI workflows that automate browser tasks using n8n and eGovernmentOS MCP.

## Prerequisites

- Node.js and npm installed ([nodejs.org](https://nodejs.org))
- eGovernmentOS running with MCP server enabled
...
<Note>
  Replace `9101` with your eGovernmentOS MCP port from **Settings → MCP** in eGovernmentOS.
</Note>
...
```
Open google.com in eGovernmentOS
```

Execute and watch eGovernmentOS respond!
...
<Warning>
  ...
  - eGovernmentOS is running
  - MCP server is enabled in eGovernmentOS settings
  - Port number matches your eGovernmentOS MCP configuration
</Warning>

## Resources

<Card title="eGovernmentOS MCP Guide" icon="book" href="/egovernmentos-mcp/how-to-guide">
  Learn more about eGovernmentOS MCP
</Card>