...
Hey there! Thanks for your interest in eGovernmentOS. Whether you're fixing bugs, adding features, improving docs, or just poking around the code, we're glad you're here.
...
<Tabs>
  ...
  <Tab title="💡 Suggest Features">
    Have an idea? [Share it here](https://github.com/mukira/eGovermentOS/issues/99) or chat with us on [Discord](https://discord.gg/YKwjt5vuKr).
  </Tab>
