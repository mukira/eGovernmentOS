---
title: "Contributing to eGovernmentOS"
description: "Help build the operating system for digital sovereignty"
icon: "code-branch"
---

Thank you for your interest in eGovernmentOS. Whether you're enhancing security features, improving automation capabilities, refining documentation, or exploring the codebase, we're glad you're here. Every contribution strengthens governments' capacity for digital independence.

eGovernmentOS is a monorepo with two main parts:
- **Agent** - The Chrome extension with AI features (TypeScript/React)
- **Browser** - The custom Chromium build (C++/Python)

Most contributors start with the agent since it's faster to set up and iterate on.
...
<CardGroup cols={3}>
  <Card
    title="Source Code"
    icon="code"
    href="https://github.com/mukira/eGovermentOS"
  >
  ...
  <Card
    title="Report Issues"
    icon="bug"
    href="https://github.com/mukira/eGovermentOS/issues"
  >
...
You can contribute to eGovernmentOS in many ways! Whether you want to build features or help out in other ways, we appreciate all contributions.

<Tabs>
  <Tab title="🐛 Report Bugs">
    Found a bug? [Open an issue](https://github.com/mukira/eGovermentOS/issues/new) with:
    - Clear description
    - Steps to reproduce
    - Expected vs actual behavior
    - Screenshots/videos
    - Environment details (OS, browser version, eGovernmentOS version)
  </Tab>

  <Tab title="💡 Suggest Features">
    Have an idea? [Share it here](https://github.com/mukira/eGovermentOS/issues/99) or chat with us on [Discord](https://discord.gg/25Ur5Ss7).
  </Tab>
...
<Steps>
  <Step title="Navigate to Agent Directory">
    ```bash
    cd packages/egovernmentos-agent
    ```
  </Step>
...
<Steps>
  ...
  <Step title="Load Unpacked Extension">
    Click **Load unpacked** and select `packages/egovernmentos-agent/dist/`
  </Step>
...
<Note>
For detailed setup, architecture, and code standards, see the [Agent Contributing Guide](https://github.com/mukira/eGovermentOS/blob/main/packages/egovernmentos-agent/CONTRIBUTING.md).
</Note>
...
<Steps>
  ...
  <Step title="Run eGovernmentOS">
    After the build completes successfully, you can run eGovernmentOS:

    <Tabs>
      <Tab title="macOS Debug (ARM64)">
        ```bash
        out/Default_arm64/eGovernmentOS\ Dev.app/Contents/MacOS/eGovernmentOS\ Dev --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Debug (x64)">
        ```bash
        out/Default_x64/eGovernmentOS\ Dev.app/Contents/MacOS/eGovernmentOS\ Dev --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Release (ARM64)">
        ```bash
        out/Default_arm64/eGovernmentOS.app/Contents/MacOS/eGovernmentOS --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Release (x64)">
        ```bash
        out/Default_x64/eGovernmentOS.app/Contents/MacOS/eGovernmentOS --user-data-dir=/tmp/test-profile
        ```
      </Tab>
...
<Steps>
  <Step title="Read the CLA">
    Read the [CLA document](https://github.com/mukira/eGovermentOS/blob/main/CLA.md)
  </Step>
...
- Agent: [packages/egovernmentos-agent/CLAUDE.md](https://github.com/mukira/eGovermentOS/blob/main/packages/egovernmentos-agent/CLAUDE.md)
</Note>
...
<Steps>
  <Step title="Fork and Clone">
    ...
    ```bash
    git clone https://github.com/YOUR-USERNAME/eGovermentOS.git
    cd eGovernmentOS
    ```
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="comments"
    href="https://github.com/mukira/eGovermentOS/discussions"
  >
    General questions
  </Card>
</CardGroup>
