---
title: "Gemini"
description: "Configure eGovernmentOS to use Google's Gemini AI model"
---

Gemini 2.5 Flash is fast, powerful, and free. Google AI Studio gives you 20 requests per minute at no cost - perfect for eGovernmentOS.
...
Navigate to `chrome://egovernmentos/settings` or click the **Settings** icon on the new tab page, then click **USE** on the Gemini card.
...
Done! You're ready to use eGovernmentOS with Gemini.