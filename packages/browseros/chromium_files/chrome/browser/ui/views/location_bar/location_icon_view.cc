...
LocationIconView::LocationIconView(
    ...
    IconLabelBubbleView::Delegate *parent_delegate, Delegate *delegate)
...
void LocationIconView::AddedToWidget() { Update(true); }
...
gfx::Size
LocationIconView::GetMinimumSizeForPreferredSize(gfx::Size size) const {
