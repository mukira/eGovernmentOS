...
public:
  ...
  // eGovernmentOS: Allow explicit color override
  ...
  void
  ViewHierarchyChanged(const ViewHierarchyChangedDetails &details) override;
...
private:
  ...
  // eGovernmentOS: Explicit color override
  std::optional<SkColor> color_user_override_;
...
VIEWS_EXPORT SkPath GetHighlightPath(
    const View *view, float halo_thickness = FocusRing::kDefaultHaloThickness);
...
VIEWS_EXPORT extern const ui::ClassProperty<bool>
    *const kDrawFocusRingBackgroundOutline;
