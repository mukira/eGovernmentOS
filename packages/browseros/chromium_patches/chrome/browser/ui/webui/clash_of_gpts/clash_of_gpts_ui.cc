diff-- git a / chrome / browser / ui / webui / clash_of_gpts /
        clash_of_gpts_ui.cc b / chrome / browser / ui / webui / clash_of_gpts /
        clash_of_gpts_ui.cc new file
            mode 100644 index 0000000000000..ce25eefa09ff9 -- -/
        dev / null++ +
    b / chrome / browser / ui / webui / clash_of_gpts /
        clash_of_gpts_ui.cc @ @-0,
    0 + 1,
    104 @ @+ // Copyright 2025 The Chromium Authors
        + // Use of this source code is governed by a BSD-style license that can
          // be
        + // found in the LICENSE file.
        + +#include "chrome/browser/ui/webui/clash_of_gpts/clash_of_gpts_ui.h" +
        +#include<memory> + +#include "base/memory/ref_counted_memory.h" +
