diff-- git a / chrome / browser / chrome_browser_main.cc b / chrome / browser /
        chrome_browser_main.cc index 03aef97f335b0..c6b111da5e01e 100644 -- -a /
        chrome / browser / chrome_browser_main.cc++ +
    b / chrome / browser / chrome_browser_main.cc @ @-10,
    6 + 10,
    7 @ @
#include <utility>
...
#include "base/command_line.h"
    @ @-998,
    6 + 999, 8 @ @ int ChromeBrowserMainParts::PreCreateThreadsImpl() {
...
+})";
  ...
  +#endif // BUILDFLAG(IS_MAC)
      ...
      @ @-1414,
      6 + 1454, 10 @ @ int ChromeBrowserMainParts::PreMainMessageLoopRunImpl() {
    // running.
    browser_process_->PreMainMessageLoopRun();

    + // BrowserOS: Start the BrowserOS server after browser initialization
        +LOG(INFO)
        << "browseros: Starting BrowserOS server process";
    ...
    +
        ...
        @ @-1855,
        6 + 1899, 11 @ @ void ChromeBrowserMainParts::PostMainMessageLoopRun() {
      for (auto &chrome_extra_part : chrome_extra_parts_)
        chrome_extra_part->PostMainMessageLoopRun();

      + + // BrowserOS: Stop the BrowserOS server during shutdown
          +LOG(INFO)
          << "browseros: Stopping BrowserOS server process";
